  ...
  <div id="museumByIdDiv">
    ...
    <dialog id="my_modal_4" class="modal">
      <div class="modal-box w-11/12 max-w-6xl">
        ...
        >
          <h1 class="text-3xl font-bold">Musée national de l'automobile - Collection Schlumpf</h1>
          <form method="dialog">
        ...
        <div id="modalBody">
          <div class="container modalBodyPart">
            <img src="../assets/collection-schlumpf.jpg" style="border-radius: 10%" class="mb-5" />
            <div class="container mb-5">
              <div>
                <h2 class="text-2xl mb-2">Domaines thématiques :</h2>
                <hr />
                <br />
            ...
            <div class="container mb-5">
              <div>
                ...
                >
                <br />
                <span class="font-semibold">Date de mise à jour des données : </span>
                <span
                  >25/01/2024</span
                >
                <br />
                <span class="font-semibold">Téléphone : </span>
                <span>03 89 33 23 23</span>
              </div>
            </div>
          </div>
          <div class="container modalBodyPart">
            <div class="container mb-5">
              <div>
                <h2 class="text-2xl mb-2">Informations générales:</h2>
                <hr />
                <br />
                <span class="font-semibold">Nom officiel : </span>
                <span>Musée national de l'automobile - Collection Schlumpf</span>
                <br />
            ...
            <div class="container mb-5">
              <h2 class="text-2xl mb-2">Histoire :</h2>
              <hr>
              <br>
              <div class="scrollable-container"><p>Le musée conserve la collection des frères Schlumpf (environ 480 pièces dont 422 ont été classées au titre des Monuments historiques), constituée entre 1961 et 1963. Pour effectuer ces achats, Fritz Schlumpf noue une série de contacts avec des « rabatteurs » en France, en Suisse, en Angleterre, en Italie, en Allemagne et aux Etats-Unis. Le riche industriel achète sans répit les voitures européennes de la haute époque en refusant les modèles américains. Dans les années 1970, la crise textile frappe les entreprises Schlumpf et les deux frères sont contraints de déposert le bilan. En 1981, l'Association du Musée national de l'Automobile – qui regroupe la ville de Mulhouse, le Département du Haut-Rhin, la Région Alsace, la Chambre de Commerce et d'Industrie de Mulhouse, l'Automobile Club de France, la Société Panhard et le Comité du salon de l'Automobile – rachète la collection pour 44 millions de francs, rachat autorisé par la Cour de cassation l’année précédente. Le 10 juillet 1982, le Musée national de l’Automobile ouvre au public. En 1989, suite à des arrêts de la Cour d'appel de Paris, le Musée national de l'Automobile est contraint d'ajouter « Collection Schlumpf » à son nom et sur tous les documents mentionnant un élément de la collection. De nouvelles pièces ont été acquises, données ou prêtées depuis 1982.</p></div>
            </div>
            <div class="container mb-5">
              <h2 class="text-2xl mb-2">Personnages Phares :</h2>
              <hr>
              <br>
              <div class="scrollable-container"><p>Hans et Fritz Schlumpf, Ettore et Jean Bugatti</p></div>
            </div>  
            <div class="container mb-5">
              <h2 class="text-2xl mb-2">Intêrets :</h2>
              <hr>
              <br>
              <div class="scrollable-container"><p>Le musée est installé dans une ancienne filature construite en 1880. L'accès à l'imposante entrée de la Cité de l'Automobile se fait grâce à une passerelle enjambant le canal. Cet espace a été conçu par le Studio Milou en 2006 lors de la création des nouveaux espaces d'accueil et de découverte. Il symbolise la création et l'imagination humaine, particulièrement fertiles dans le domaine de l'automobile.</p></div>
            </div>
          </div>
        </div>
      </div>
