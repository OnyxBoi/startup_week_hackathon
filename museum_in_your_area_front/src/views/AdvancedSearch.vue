...
<template>
  ...
  <dialog id="museumModal" class="modal">
    <div class="modal-box w-11/12 max-w-6xl">
      ...
      >
        <h1 id="modalTitle" class="text-3xl font-bold">musée national de l'automobile - collection Schlumpf</h1>
        <form method="dialog">
        ...
        <div class="container modalBodyPart">
          ...
          <div class="container mb-5">
            <div>
              ...
              >
              <br />
              <span id="modalUpdateDateTitle" class="font-semibold">Date de mise à jour des données : </span>
